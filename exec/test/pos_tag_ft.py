...
from dzdt.model.classif import FTTokenSeqClassifier
...
from dzdt.pipeline.pttrainers import SimpleTrainerConfig, FTSimpleTrainer
from dzdt.pipeline.pttesters import SimpleTesterConfig, FTSimpleTester
...
def train_model(params):
    ...
    pos_decoder = FTTokenSeqClassifier(encoder_params, decoder_params, params.p)
    ...
    trainer = FTSimpleTrainer(config)#, device=torch.device("cpu")
    ...
    print("saving models ...")
    pos_decoder.save(params.mdl_url)
...
def test_model(params):
    ...
    pos_decoder = FTTokenSeqClassifier.load(params.mdl_url)
